<div class="wpuf-user-loggedin">
	...
	<!--<ul>
		<li><?php //printf( __( 'Salut %s', 'wpuf' ), $user->display_name ); ?></li>
	</ul>-->

	<?php //printf( __( 'In acest moment esti autentificat! %s?', 'wpuf' ), wp_loginout( '', false ) ) ?>
...
<div class="row">
        ...
        <div class="col-lg-6 col-sm-6 focus-box" data-scrollreveal="enter left after 0.15s over 1s">
            ...
            <h3 class="red-border-bottom">SIMPLIFICARE PENTRU COMPANII ȘI ALTE ORGANIZAȚII</h3>
            <!-- FOCUS HEADING -->
...
<div class="buttons"><a href="http://maisimplu.gov.ro/propunere/companie/" class="btn btn-primary custom-button red-btn">Propune o imbunatatire pentru companii</a>	</div>	
        ...
        <div class="col-lg-6 col-sm-6 focus-box" data-scrollreveal="enter left after 0.15s over 1s">
            ...
            <h3 class="red-border-bottom">SIMPLIFICARE PENTRU CETĂȚENI</h3>
            <!-- FOCUS HEADING -->
