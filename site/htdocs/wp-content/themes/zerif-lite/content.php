<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		...
		<h1 class="entry-title"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h1><?php if(function_exists('the_ratings')) { the_ratings(); } ?>
	...
	<footer class="entry-footer">
		...
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<span class="cat-links">
				...
				<?php printf( __( 'Categoria: %1$s', 'zerif-lite' ), $categories_list ); ?>
			...
			<span class="tags-links">
				...
				<?php printf( __( 'Etichetat: %1$s', 'zerif-lite' ), $tags_list ); ?>
