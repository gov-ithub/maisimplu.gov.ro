...
<div class="container">
	...
	<?php
		$footer_sections = 0;
		$zerif_address = get_theme_mod('zerif_address',__('Company address','mai-simplu'));
		...
		!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
					...
					echo '<!--<div class="zerif-copyright-box"><a class="zerif-copyright" href="http://themeisle.com/themes/mai-simplu/"'.$attribut_new_tab.' rel="nofollow">Zerif Lite </a>'.__('powered by','mai-simplu').'<a class="zerif-copyright" href="http://wordpress.org/"'.$attribut_new_tab.' rel="nofollow"> WordPress</a></div>-->';
