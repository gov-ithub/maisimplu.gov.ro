	...
	echo '<section class="our-team" id="team">';
		echo '<div class="container">';
			echo '<div class="section-header">';
				...
				$zerif_ourteam_title = get_theme_mod('zerif_ourteam_title',__('YOUR TEAM','mai-simplu'));
				...
				$zerif_ourteam_subtitle = get_theme_mod('zerif_ourteam_subtitle',__('Prove that you have real people working for you, with some nice looking profile pictures and links to social media.','mai-simplu'));
