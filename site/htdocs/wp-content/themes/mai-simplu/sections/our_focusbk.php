...
<div class="container">
	...
	<div class="section-header">
		...
		$zerif_ourfocus_title = get_theme_mod('zerif_ourfocus_title',__('FEATURES','mai-simplu'));
		...
		$zerif_ourfocus_subtitle = get_theme_mod('zerif_ourfocus_subtitle',__('What makes this single-page WordPress theme unique.','mai-simplu'));
