<?php
/**
 * Template Name: Blog - tag cu tabel cetateni
 */
get_header(); ?>
<div class="clear"></div>
...
<h1>Tabel 300 propuneri cetateni </h1>
	...
	<div class="container">
			...
			<?php //query_posts( array( 'meta_key' => 'ratings_users', 'orderby' => 'meta_value_num', 'order' => 'DESC', 'showposts' => '50' ) ); ?>
				...
				<main id="main" class="site-main" role="main">
					...
					$wp_query = new WP_Query( array('post_type' => 'post','cat' => '1', 'showposts' => '300', 'paged' => $paged , 'meta_key' => 'ratings_users', 'orderby' => 'meta_value_num', 'order' => 'DESC',) ); ?>
