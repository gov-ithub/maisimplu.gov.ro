...
<div id="actions_required" class="mai-simplu-tab-pane">

    <h1><?php esc_html_e( 'Keep up with Zerif Lite\'s latest news' ,'mai-simplu' ); ?></h1>
	...
	if( $nr_actions_required == 0 ):
		echo '<p>'.__( 'Hooray! There are no required actions for you right now.','mai-simplu' ).'</p>';
	endif;
	?>
