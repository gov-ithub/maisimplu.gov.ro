...
class Zerif_Welcome {
	...
	public function zerif_lite_welcome_register_menu() {
		add_theme_page( 'About Zerif Lite', 'About Zerif Lite', 'activate_plugins', 'mai-simplu-welcome', array( $this, 'zerif_lite_welcome_screen' ) );
	}
	...
	public function zerif_lite_welcome_admin_notice() {
		?>
			<div class="updated notice is-dismissible">
				<p><?php echo sprintf( esc_html__( 'Welcome! Thank you for choosing Zerif Lite! To fully take advantage of the best our theme can offer please make sure you visit our %swelcome page%s.', 'mai-simplu' ), '<a href="' . esc_url( admin_url( 'themes.php?page=mai-simplu-welcome' ) ) . '">', '</a>' ); ?></p>
				<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=mai-simplu-welcome' ) ); ?>" class="button" style="text-decoration: none;"><?php _e( 'Get started with Zerif Lite', 'mai-simplu' ); ?></a></p>
			</div>
		<?php
	}
	...
	public function zerif_lite_welcome_style_and_scripts( $hook_suffix ) {
		...
		if ( 'appearance_page_mai-simplu-welcome' == $hook_suffix ) {
			wp_enqueue_style( 'mai-simplu-welcome-screen-css', get_template_directory_uri() . '/inc/admin/welcome-screen/css/welcome.css' );
			wp_enqueue_script( 'mai-simplu-welcome-screen-js', get_template_directory_uri() . '/inc/admin/welcome-screen/js/welcome.js', array('jquery') );
			...
			wp_localize_script( 'mai-simplu-welcome-screen-js', 'zerifLiteWelcomeScreenObject', array(
				'nr_actions_required' => $nr_actions_required,
				'ajaxurl' => admin_url( 'admin-ajax.php' ),
				'template_directory' => get_template_directory_uri(),
				'no_required_actions_text' => __( 'Hooray! There are no required actions for you right now.','mai-simplu' )
			) );
		}
	}
	...
	public function zerif_lite_welcome_scripts_for_customizer() {
		...
		wp_enqueue_style( 'mai-simplu-welcome-screen-customizer-css', get_template_directory_uri() . '/inc/admin/welcome-screen/css/welcome_customizer.css' );
		wp_enqueue_script( 'mai-simplu-welcome-screen-customizer-js', get_template_directory_uri() . '/inc/admin/welcome-screen/js/welcome_customizer.js', array('jquery'), '20120206', true );
		...
		wp_localize_script( 'mai-simplu-welcome-screen-customizer-js', 'zerifLiteWelcomeScreenCustomizerObject', array(
			'nr_actions_required' => $nr_actions_required,
			'aboutpage' => esc_url( admin_url( 'themes.php?page=mai-simplu-welcome#actions_required' ) ),
			'customizerpage' => esc_url( admin_url( 'customize.php#actions_required' ) ),
			'themeinfo' => __('View Theme Info','mai-simplu'),
		) );
	}
	...
	public function zerif_lite_welcome_screen() {
		...
		<ul class="mai-simplu-nav-tabs" role="tablist">
			<li role="presentation" class="active"><a href="#getting_started" aria-controls="getting_started" role="tab" data-toggle="tab"><?php esc_html_e( 'Getting started','mai-simplu'); ?></a></li>
			<li role="presentation" class="mai-simplu-w-red-tab"><a href="#actions_required" aria-controls="actions_required" role="tab" data-toggle="tab"><?php esc_html_e( 'Actions required','mai-simplu'); ?></a></li>
			<li role="presentation"><a href="#child_themes" aria-controls="child_themes" role="tab" data-toggle="tab"><?php esc_html_e( 'Child themes','mai-simplu'); ?></a></li>
			<li role="presentation"><a href="#github" aria-controls="github" role="tab" data-toggle="tab"><?php esc_html_e( 'Contribute','mai-simplu'); ?></a></li>
			<li role="presentation"><a href="#changelog" aria-controls="changelog" role="tab" data-toggle="tab"><?php esc_html_e( 'Changelog','mai-simplu'); ?></a></li>
			<li role="presentation"><a href="#free_pro" aria-controls="free_pro" role="tab" data-toggle="tab"><?php esc_html_e( 'Free VS PRO','mai-simplu'); ?></a></li>
		</ul>

		<div class="mai-simplu-tab-content">
