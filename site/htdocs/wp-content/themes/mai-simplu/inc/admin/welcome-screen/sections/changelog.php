...
$zerif_lite = wp_get_theme( 'mai-simplu' );

?>
<div class="mai-simplu-tab-pane" id="changelog">

	<div class="zerif-tab-pane-center">

		<h1>Zerif Lite <?php if( !empty($zerif_lite['Version']) ): ?> <sup id="mai-simplu-theme-version"><?php echo esc_attr( $zerif_lite['Version'] ); ?> </sup><?php endif; ?></h1>
