...
function zerif_customize_register( $wp_customize ) {
	...
	class Zerif_Theme_Support extends WP_Customize_Control {
		public function render_content() {
			echo __('Check out the <a href="http://themeisle.com/themes/zerif-pro-one-page-wordpress-theme/">PRO version</a> for full control over the frontpage SECTIONS ORDER and the COLOR SCHEME!','mai-simplu');
		}
	}

	class Zerif_Theme_Support_Videobackground extends WP_Customize_Control {
		public function render_content() {
			echo __('Check out the <a href="http://themeisle.com/themes/zerif-pro-one-page-wordpress-theme/">PRO version</a> to add a nice looking background video!','mai-simplu');
		}
	}

	class Zerif_Theme_Support_Googlemap extends WP_Customize_Control {
		public function render_content() {
			echo __('Check out the <a href="http://themeisle.com/themes/zerif-pro-one-page-wordpress-theme/">PRO version</a> to add a google maps section !','mai-simplu');
		}
	}

	class Zerif_Theme_Support_Pricing extends WP_Customize_Control {
		public function render_content() {
			echo __('Check out the <a href="http://themeisle.com/themes/zerif-pro-one-page-wordpress-theme/">PRO version</a> to add a pricing section !','mai-simplu');
		}
	}
	...
	$wp_customize->add_section( 'zerif_order_section', array(
		'title'	=> __( 'Sections order and Colors', 'mai-simplu' ),
		'priority' => 28
	));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		$wp_customize->add_panel( 'panel_general', array(
			...
			'title' => __( 'General options', 'mai-simplu' )
		));

		$wp_customize->add_section( 'zerif_general_section' , array(
			'title' => __( 'General', 'mai-simplu' ),
			'priority' => 30,
			'panel' => 'panel_general'
		));
		...
		$wp_customize->add_control( 'zerif_disable_preloader', array(
			'type' => 'checkbox',
			'label' => __('Disable preloader?','mai-simplu'),
		...
		$wp_customize->add_control( 'zerif_disable_smooth_scroll', array(
			'type' 		=> 'checkbox',
			'label' 	=> __('Disable smooth scroll?','mai-simplu'),
			'section' 	=> 'zerif_general_section',
			'priority'	=> 3,
		));
		...
		$wp_customize->add_control( 'zerif_accessibility', array(
			'type' 		=> 'checkbox',
			'label' 	=> __('Enable accessibility?','mai-simplu'),
			'section' 	=> 'zerif_general_section',
			'priority'	=> 3,
		));
		...
		$wp_customize->add_control( 'zerif_copyright', array(
			'label'    => __( 'Footer Copyright', 'mai-simplu' ),
			'section'  => 'zerif_general_section',
			'priority'    => 3,
		));

		$wp_customize->add_section( 'zerif_general_socials_section' , array(
			'title' => __( 'Footer Social Icons', 'mai-simplu' ),
			'priority' => 31,
			'panel' => 'panel_general'
		));
		...
		$wp_customize->add_control( 'zerif_socials_facebook', array(
			'label'    => __( 'Facebook link', 'mai-simplu' ),
		...
		$wp_customize->add_control( 'zerif_socials_twitter', array(
			'label'    => __( 'Twitter link', 'mai-simplu' ),
			'section'  => 'zerif_general_socials_section',
			'priority' => 5,
		));
		...
		$wp_customize->add_control( 'zerif_socials_linkedin', array(
			'label'    => __( 'Linkedin link', 'mai-simplu' ),
			'section'  => 'zerif_general_socials_section',
			'priority' => 6,
		));
		...
		$wp_customize->add_control( 'zerif_socials_behance', array(
			'label'    => __( 'Behance link', 'mai-simplu' ),
			'section'  => 'zerif_general_socials_section',
			'priority' => 7,
		));
		...
		$wp_customize->add_control( 'zerif_socials_dribbble', array(
			'label'    => __( 'Dribbble link', 'mai-simplu' ),
			'section'  => 'zerif_general_socials_section',
			'priority' => 8,
		));
		...
		$wp_customize->add_control( 'zerif_socials_instagram', array(
			'label'    => __( 'Instagram link', 'mai-simplu' ),
			'section'  => 'zerif_general_socials_section',
			'priority' => 9,
		));

		$wp_customize->add_section( 'zerif_general_footer_section' , array(
			'title' => __( 'Footer Content', 'mai-simplu' ),
			'priority' => 32,
			'panel' => 'panel_general'
		));
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'zerif_address_icon', array(
			'label'    => __( 'Address section - icon', 'mai-simplu' ),
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'zerif_email_icon', array(
			'label'    => __( 'Email section - icon', 'mai-simplu' ),
			'section'  => 'zerif_general_footer_section',
			'priority'    => 11,
		)));
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'zerif_phone_icon', array(
			'label'    => __( 'Phone number section - icon', 'mai-simplu' ),
			'section'  => 'zerif_general_footer_section',
			'priority' => 13,
		)));
		...
		$wp_customize->add_control(new Zerif_Customize_Textarea_Control( $wp_customize, 'zerif_phone', array(
			'label'   => __( 'Phone number', 'mai-simplu' ),
			'section' => 'zerif_general_footer_section',
			'priority' => 14
		)));
		...
		$wp_customize->add_section( 'zerif_general_section' , array(
			'title'       => __( 'General options', 'mai-simplu' ),
			'priority'    => 30,
			'description' => __('Zerif theme general options','mai-simplu'),
		));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		$wp_customize->add_panel( 'panel_big_title', array(
			'priority' => 31,
			'capability' => 'edit_theme_options',
			'title' => __( 'Big title section', 'mai-simplu' )
		));

		$wp_customize->add_section( 'zerif_bigtitle_section' , array(
			'title'       => __( 'Main content', 'mai-simplu' ),
			'priority'    => 1,
		...
		$wp_customize->add_control( 'zerif_bigtitle_show', array(
			'type' => 'checkbox',
			'label' => __('Hide big title section?','mai-simplu'),
		...
		$wp_customize->add_setting( 'zerif_bigtitle_title', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('ONE OF THE TOP 10 MOST POPULAR THEMES ON WORDPRESS.ORG','mai-simplu'),
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_bigtitle_title', array(
			'label'    => __( 'Title', 'mai-simplu' ),
			'section'  => 'zerif_bigtitle_section',
			'priority'    => 2,
		));
		...
		$wp_customize->add_setting( 'zerif_bigtitle_redbutton_label', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('Features','mai-simplu'),
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_bigtitle_redbutton_label', array(
			'label'    => __( 'Red button label', 'mai-simplu' ),
			'section'  => 'zerif_bigtitle_section',
			'priority'    => 3,
		));
		...
		$wp_customize->add_control( 'zerif_bigtitle_redbutton_url', array(
			'label'    => __( 'Red button link', 'mai-simplu' ),
			'section'  => 'zerif_bigtitle_section',
			'priority'    => 4,
		));
		...
		$wp_customize->add_setting( 'zerif_bigtitle_greenbutton_label', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __("What's inside",'mai-simplu'),
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_bigtitle_greenbutton_label', array(
			'label'    => __( 'Green button label', 'mai-simplu' ),
			'section'  => 'zerif_bigtitle_section',
			'priority'    => 5,
		));
		...
		$wp_customize->add_control( 'zerif_bigtitle_greenbutton_url', array(
			'label'    => __( 'Green button link', 'mai-simplu' ),
			'section'  => 'zerif_bigtitle_section',
			'priority'    => 6,
		));
		...
		$wp_customize->add_section( 'zerif_parallax_section' , array(
			'title'       => __( 'Parallax effect', 'mai-simplu' ),
			'priority'    => 2,
			'panel'       => 'panel_big_title'
		));
		...
		$wp_customize->add_control( 'zerif_parallax_show', array(
			'type' 		=> 'checkbox',
			'label' 	=> __('Use parallax effect?','mai-simplu'),
		...
		$wp_customize->add_section( 'zerif_videobackground_in_pro_section' , array(
			'title'       => __( 'Video background', 'mai-simplu' ),
			'priority'    => 3,
			'panel'       => 'panel_big_title'
		));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		$wp_customize->add_panel( 'panel_ourfocus', array(
			'priority' => 32,
			'capability' => 'edit_theme_options',
			'title' => __( 'Our focus section', 'mai-simplu' )
		));

		$wp_customize->add_section( 'zerif_ourfocus_section' , array(
			'title'       => __( 'Content', 'mai-simplu' ),
			'priority'    => 1,
		...
		$wp_customize->add_control( 'zerif_ourfocus_show', array(
			'type' => 'checkbox',
			'label' => __('Hide our focus section?','mai-simplu'),
		...
		$wp_customize->add_setting( 'zerif_ourfocus_subtitle', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('What makes this single-page WordPress theme unique.','mai-simplu'),
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_ourfocus_subtitle', array(
			'label'    => __( 'Our focus subtitle', 'mai-simplu' ),
			'section'  => 'zerif_ourfocus_section',
			'priority'    => 3,
		));
		...
		$wp_customize->add_section( 'zerif_ourfocus_section' , array(
			'title'       => __( 'Our focus section', 'mai-simplu' ),
			'priority'    => 32,
			'description' => __( 'The main content of this section is customizable in: Dashboard -> Appearance -> Widgets -> Our focus section. There you must add the "Zerif - Our focus widget"', 'mai-simplu' )
		));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		$wp_customize->add_panel( 'panel_about', array(
			'priority' => 34,
			'capability' => 'edit_theme_options',
			'title' => __( 'About us section', 'mai-simplu' )
		));

		$wp_customize->add_section( 'zerif_aboutus_settings_section' , array(
			'title'       => __( 'Settings', 'mai-simplu' ),
			'priority'    => 1,
			'panel' => 'panel_about'
		));
		...
		$wp_customize->add_control( 'zerif_aboutus_show', array(
			'type' => 'checkbox',
			'label' => __('Hide about us section?','mai-simplu'),
		...
		$wp_customize->add_setting( 'zerif_aboutus_subtitle', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('Use this section to showcase important details about your business.','mai-simplu'),
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_aboutus_subtitle', array(
			'label'    => __( 'Subtitle', 'mai-simplu' ),
			'section'  => 'zerif_aboutus_main_section',
			'priority'    => 3,
		));
		...
		$wp_customize->add_setting( 'zerif_aboutus_biglefttitle', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('Everything you see here is responsive and mobile-friendly.','mai-simplu'),
		));

		$wp_customize->add_control( 'zerif_aboutus_biglefttitle', array(
			'label'    => __( 'Big left side title', 'mai-simplu' ),
			'section'  => 'zerif_aboutus_main_section',
			'priority'    => 4,
		));
		...
		$wp_customize->add_setting( 'zerif_aboutus_feature1_title', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('YOUR SKILL #1','mai-simplu'),
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_aboutus_feature1_title', array(
			'label'    => __( 'Feature no1 title', 'mai-simplu' ),
		...
		$wp_customize->add_control( 'zerif_aboutus_feature1_text', array(
			'label'    => __( 'Feature no1 text', 'mai-simplu' ),
			'section'  => 'zerif_aboutus_feat1_section',
			'priority'    => 7,
		));
		...
		$wp_customize->add_control( new Zerif_Customizer_Number_Control( $wp_customize, 'zerif_aboutus_feature1_nr', array(
			'type' => 'number',
			'label' => __( 'Feature no1 percentage', 'mai-simplu' ),
			'section' => 'zerif_aboutus_feat1_section',
			'priority'    => 8
		)));

		$wp_customize->add_section( 'zerif_aboutus_feat2_section' , array(
			'title'       => __( 'Feature no#2', 'mai-simplu' ),
			'priority'    => 4,
			'panel' => 'panel_about'
		));
		...
		$wp_customize->add_setting( 'zerif_aboutus_feature2_title', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('YOUR SKILL #2','mai-simplu'),
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_aboutus_feature2_title', array(
			'label'    => __( 'Feature no2 title', 'mai-simplu' ),
		...
		$wp_customize->add_control( 'zerif_aboutus_feature2_text', array(
			'label'    => __( 'Feature no2 text', 'mai-simplu' ),
			'section'  => 'zerif_aboutus_feat2_section',
			'priority'    => 10,
		));
		...
		$wp_customize->add_control( new Zerif_Customizer_Number_Control( $wp_customize, 'zerif_aboutus_feature2_nr', array(
			'type' => 'number',
			'label' => __( 'Feature no2 percentage', 'mai-simplu' ),
			'section' => 'zerif_aboutus_feat2_section',
			'priority'    => 11
		)));

		$wp_customize->add_section( 'zerif_aboutus_feat3_section' , array(
			'title'       => __( 'Feature no#3', 'mai-simplu' ),
			'priority'    => 5,
			'panel' => 'panel_about'
		));
		...
		$wp_customize->add_setting( 'zerif_aboutus_feature3_title', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('YOUR SKILL #3','mai-simplu'),
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_aboutus_feature3_title', array(
			'label'    => __( 'Feature no3 title', 'mai-simplu' ),
		...
		$wp_customize->add_control( 'zerif_aboutus_feature3_text', array(
			'label'    => __( 'Feature no3 text', 'mai-simplu' ),
			'section'  => 'zerif_aboutus_feat3_section',
			'priority'    => 13,
		));
		...
		$wp_customize->add_control( new Zerif_Customizer_Number_Control( $wp_customize, 'zerif_aboutus_feature3_nr', array(
			'type' => 'number',
			'label' => __( 'Feature no3 percentage', 'mai-simplu' ),
			'section' => 'zerif_aboutus_feat3_section',
			'priority'    => 14
		)));

		$wp_customize->add_section( 'zerif_aboutus_feat4_section' , array(
			'title'       => __( 'Feature no#4', 'mai-simplu' ),
			'priority'    => 6,
			'panel' => 'panel_about'
		));
		...
		$wp_customize->add_setting( 'zerif_aboutus_feature4_title', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('YOUR SKILL #4','mai-simplu'),
			'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_aboutus_feature4_title', array(
			'label'    => __( 'Feature no4 title', 'mai-simplu' ),
		...
		$wp_customize->add_control( 'zerif_aboutus_feature4_text', array(
			'label'    => __( 'Feature no4 text', 'mai-simplu' ),
			'section'  => 'zerif_aboutus_feat4_section',
			'priority'    => 16,
		));
		...
		$wp_customize->add_control( new Zerif_Customizer_Number_Control( $wp_customize, 'zerif_aboutus_feature4_nr', array(
			'type' => 'number',
			'label' => __( 'Feature no4 percentage', 'mai-simplu' ),
			'section' => 'zerif_aboutus_feat4_section',
			'priority' => 17
		)));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		$wp_customize->add_panel( 'panel_ourteam', array(
			'priority' => 35,
			'capability' => 'edit_theme_options',
			'title' => __( 'Our team section', 'mai-simplu' )
		));
		...
		$wp_customize->add_control( 'zerif_ourteam_show', array(
			'type' => 'checkbox',
			'label' => __('Hide our team section?','mai-simplu'),
		...
		$wp_customize->add_setting( 'zerif_ourteam_title', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('YOUR TEAM','mai-simplu'),
			'transport' => 'postMessage'
		));
		...
		$wp_customize->add_setting( 'zerif_ourteam_subtitle', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('Prove that you have real people working for you, with some nice looking profile pictures and links to social media.','mai-simplu'),'transport' => 'postMessage'
		));

		$wp_customize->add_control( 'zerif_ourteam_subtitle', array(
			'label'    => __( 'Our team subtitle', 'mai-simplu' ),
			'section'  => 'zerif_ourteam_section',
			'priority'    => 3,
		));
		...
		$wp_customize->add_section( 'zerif_ourteam_section' , array(
			'title'       => __( 'Our team section', 'mai-simplu' ),
			'priority'    => 35,
			'description' => __( 'The main content of this section is customizable in: Dashboard -> Appearance -> Widgets -> Our team section. There you must add the "Zerif - Team member widget"', 'mai-simplu' )
		));
		...
		$wp_customize->add_setting( 'zerif_ourteam_subtitle', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('Prove that you have real people working for you, with some nice looking profile pictures and links to social media.','mai-simplu'),
			'transport' => 'postMessage'
		));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		$wp_customize->add_panel( 'panel_testimonials', array(
			'priority' => 36,
			'capability' => 'edit_theme_options',
			'title' => __( 'Testimonials section', 'mai-simplu' )
		) );
		...
		$wp_customize->add_control( 'zerif_testimonials_show', array(
			'type' => 'checkbox',
			'label' => __('Hide testimonials section?','mai-simplu'),
		...
		$wp_customize->add_control( 'zerif_testimonials_pinterest_style', array(
			'type' 			=> 'checkbox',
			'label' 		=> __('Use pinterest layout?','mai-simplu'),
			'section' 		=> 'zerif_testimonials_section',
			'priority'    	=> 2,
		));
		...
		$wp_customize->add_setting( 'zerif_testimonials_title', array(
			'sanitize_callback' => 'zerif_sanitize_text',
			'default' => __('Testimonials','mai-simplu'),
			'transport' => 'postMessage'
		));
		...
		$wp_customize->add_control( 'zerif_testimonials_subtitle', array(
			'label'    => __( 'Testimonials subtitle', 'mai-simplu' ),
			'section'  => 'zerif_testimonials_section',
			'priority'    => 3,
		));
		...
		$wp_customize->add_section( 'zerif_testimonials_section' , array(
			'title'       => __( 'Testimonials section', 'mai-simplu' ),
			'priority'    => 36,
			'description' => __( 'The main content of this section is customizable in: Dashboard -> Appearance -> Widgets -> Testimonials section. There you must add the "Zerif - Testimonial widget"', 'mai-simplu' )
		));
	...
	$wp_customize->add_section( 'zerif_latestnews_section' , array(
		'title'       => __( 'Latest News section', 'mai-simplu' ),
    	'priority'    => 37
	));
    ...
    $wp_customize->add_control( 'zerif_latestnews_show', array(
		'type' => 'checkbox',
		'label' => __('Hide latest news section?','mai-simplu'),
	...
	$wp_customize->add_control( 'zerif_latestnews_title', array(
		'label'    		=> __( 'Latest News title', 'mai-simplu' ),
		'section'  		=> 'zerif_latestnews_section',
		'priority'    	=> 2,
	));
	...
	$wp_customize->add_control( 'zerif_latestnews_subtitle', array(
		'label'    		=> __( 'Latest News subtitle', 'mai-simplu' ),
	    'section'  		=> 'zerif_latestnews_section',
		'priority'   	=> 3,
	));
	...
	if ( class_exists( 'WP_Customize_Panel' ) ):
		...
		$wp_customize->add_panel( 'panel_ribbons', array(
			'priority' => 37,
			'capability' => 'edit_theme_options',
			'title' => __( 'Ribbon sections', 'mai-simplu' )
		));

		$wp_customize->add_section( 'zerif_bottomribbon_section' , array(
			'title'       => __( 'BottomButton Ribbon', 'mai-simplu' ),
			'priority'    => 1,
			'panel'       => 'panel_ribbons'
		));
		...
		$wp_customize->add_control( 'zerif_bottomribbon_buttonlabel', array(
			'label'    => __( 'Button label', 'mai-simplu' ),
			'section'  => 'zerif_bottomribbon_section',
			'priority'    => 2,
		));
		...
		$wp_customize->add_control( 'zerif_bottomribbon_buttonlink', array(
			'label'    => __( 'Button link', 'mai-simplu' ),
			'section'  => 'zerif_bottomribbon_section',
			'priority'    => 3,
		));

		$wp_customize->add_section( 'zerif_rightribbon_section' , array(
			'title'       => __( 'RightButton Ribbon', 'mai-simplu' ),
			'priority'    => 2,
			'panel'       => 'panel_ribbons'
		));
		...
		$wp_customize->add_control( 'zerif_bottomribbon_text', array(
			'label'    => __( 'Ribbon section with bottom button - Text', 'mai-simplu' ),
		...
		$wp_customize->add_control( 'zerif_bottomribbon_buttonlabel', array(
			'label'    => __( 'Ribbon section with bottom button - Button label', 'mai-simplu' ),
			'section'  => 'zerif_ribbon_section',
			'priority'    => 2,
		));
		...
		$wp_customize->add_control( 'zerif_bottomribbon_buttonlink', array(
			'label'    => __( 'Ribbon section with bottom button - Button link', 'mai-simplu' ),
			'section'  => 'zerif_ribbon_section',
			'priority'    => 3,
		));
		...
		$wp_customize->add_control( 'zerif_ribbonright_text', array(
			'label'    => __( 'Ribbon section with button in the right side - Text', 'mai-simplu' ),
			'section'  => 'zerif_ribbon_section',
			'priority'    => 4,
		));
		...
		$wp_customize->add_control( 'zerif_ribbonright_buttonlabel', array(
			'label'    => __( 'Ribbon section with button in the right side - Button label', 'mai-simplu' ),
			'section'  => 'zerif_ribbon_section',
			'priority'    => 5,
		));
		...
		$wp_customize->add_control( 'zerif_ribbonright_buttonlink', array(
			'label'    => __( 'Ribbon section with button in the right side - Button link', 'mai-simplu' ),
			'section'  => 'zerif_ribbon_section',
			'priority'    => 6,
		));
	endif;
	...
	if( defined("PIRATE_FORMS_VERSION") ):
		$zerif_contact_us_section_description = __( 'For more advanced settings please go to Settings -> Pirate Forms','mai-simplu' );
	endif;

	$wp_customize->add_section( 'zerif_contactus_section' , array(
		'title'       => __( 'Contact us section', 'mai-simplu' ),
    ...
    $wp_customize->add_control( 'zerif_contactus_show', array(
		'type' => 'checkbox',
		'label' => __('Hide contact us section?','mai-simplu'),
	...
	$wp_customize->add_setting( 'zerif_contactus_title', array(
		'sanitize_callback' => 'zerif_sanitize_text',
		'default' => __('Get in touch','mai-simplu'),
		'transport' => 'postMessage'
	));

	$wp_customize->add_control( 'zerif_contactus_title', array(
		'label'    => __( 'Contact us section title', 'mai-simplu' ),
		'section'  => 'zerif_contactus_section',
		'priority'    => 2,
	));
	...
	$wp_customize->add_control( 'zerif_contactus_subtitle', array(
		'label'    => __( 'Contact us section subtitle', 'mai-simplu' ),
	    'section'  => 'zerif_contactus_section',
		'priority'    => 3,
	));
	...
	$wp_customize->add_control( 'zerif_contactus_email', array(
		'label'    => __( 'Email address', 'mai-simplu' ),
		'section'  => 'zerif_contactus_section',
		'priority'    => 4,
	));
	...
	$wp_customize->add_setting( 'zerif_contactus_button_label', array(
		'sanitize_callback' => 'zerif_sanitize_text',
		'default' => __('Send Message','mai-simplu'),
		'transport' => 'postMessage'
	));
	...
	$wp_customize->add_control( 'zerif_contactus_recaptcha_show', array(
		'type' => 'checkbox',
		'label' => __('Hide reCaptcha?','mai-simplu'),
		'section' => 'zerif_contactus_section',
		'priority'    => 6,
	));
	...
	$wp_customize->add_control( 'zerif_contactus_sitekey', array(
		'label'    => __( 'Site key', 'mai-simplu' ),
		'description' => '<a'.$attribut_new_tab.' href="https://www.google.com/recaptcha/admin#list">'.__('Create an account here','mai-simplu').'</a> to get the Site key and the Secret key for the reCaptcha.',
		'section'  => 'zerif_contactus_section',
		'priority'    => 7,
	));
	...
	$wp_customize->add_control( 'zerif_contactus_secretkey', array(
		'label'    => __( 'Secret key', 'mai-simplu' ),
		'section'  => 'zerif_contactus_section',
		'priority'    => 8,
	));
	...
	$wp_customize->add_section( 'zerif_googlemap_section' , array(
		'title'       => __( 'Google maps section', 'mai-simplu' ),
		'priority'    => 120
	));
	...
	$wp_customize->add_section( 'zerif_pricing_section' , array(
		'title'       => __( 'Pricing section', 'mai-simplu' ),
		'priority'    => 121
	));
...
function zerif_registers() {
	...
	wp_localize_script( 'zerif_customizer_script', 'zerifLiteCustomizerObject', array(
		...
		'documentation' => __( 'View Documentation', 'mai-simplu' ),
		'pro' => __('View PRO version','mai-simplu')
