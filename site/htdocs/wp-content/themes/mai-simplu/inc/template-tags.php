...
function zerif_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		...
		<h2 class="screen-reader-text"><?php _e( 'Posts navigation', 'mai-simplu' ); ?></h2>

		<div class="nav-links">

			<?php if ( get_next_posts_link() ) : ?>

			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'mai-simplu' ) ); ?></div>

			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>

			<div class="nav-next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'mai-simplu' ) ); ?></div>
...
function zerif_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<h2 class="screen-reader-text"><?php _e( 'Post navigation', 'mai-simplu' ); ?></h2>

		<div class="nav-links">

			<?php

				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<span class="meta-nav">&larr;</span> %title', 'Previous post link', 'mai-simplu' ) );

				next_post_link(     '<div class="nav-next">%link</div>',     _x( '%title <span class="meta-nav">&rarr;</span>', 'Next post link',     'mai-simplu' ) );
...
function zerif_posted_on() {
	...
	printf( __( '<span class="posted-on">Posted on %1$s</span><span class="byline"> by %2$s</span>', 'mai-simplu' ),
